...
import { Box, TextField, Button, Grid, Paper, Typography, MenuItem, Stack, IconButton } from '@mui/material';
    ...
    <Paper sx={{ p: 4, borderRadius: 3 }}>
      ...
      <form onSubmit={handleSubmit}>
        <Grid container spacing={3}>
          ...
          {/* Address */}
          <Grid item xs={12}>
            <TextField fullWidth label="Address" name="location.address" value={formData.location.address} onChange={handleChange} />
          </Grid>

          {/* Area */}
          <Grid size={{ xs: 12, md: 6 }}>
            <TextField fullWidth label="Area" name="location.area" value={formData.location.area} onChange={handleChange} />
          </Grid>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Stack direction="row" spacing={1} alignItems="center">
              ...
              />
              {formData.location.gmapsLink && (
                <IconButton color="primary" component="a" href={formData.location.gmapsLink} target="_blank" rel="noopener noreferrer">
                  <OpenInNewIcon />
                </IconButton>
              )}
            </Stack>
