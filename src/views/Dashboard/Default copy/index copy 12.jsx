...
const Dashboard = () => {
  ...
  /* =====================================================
     SAFE LOADING FLAG (NO EARLY RETURN)
  ===================================================== */
      ...
      {!isReady ? (
        ...
        <>
          ...
          <Grid container spacing={3}>
            ...
            <KpiCard title="Active Coupons" value={couponAnalytics?.activeCoupons || 0} />
          </Grid>
