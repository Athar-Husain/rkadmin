  ...
  const columns = [
    {
      ...
      renderCell: (params) => (
        <Stack direction="row" spacing={1.5} alignItems="center">
          ...
          >
            <NetworkIcon sx={{ fontSize: 18, color: theme.palette.primary.main }} />
          </Box>
      ...
      renderCell: (params) => (
        <Chip
          ...
          sx={{
            fontWeight: 700,
            fontSize: '0.75rem',
            bgcolor: params.value ? alpha(theme.palette.success.main, 0.1) : alpha(theme.palette.grey[400], 0.1),
            color: params.value ? 'success.main' : 'text.secondary',
            border: '1px solid',
            borderColor: params.value ? alpha(theme.palette.success.main, 0.2) : alpha(theme.palette.grey[400], 0.2)
          }}
        />
      )
    },
      ...
      renderCell: (params) => {
        ...
        return (
          <Stack direction="row" alignItems="center" spacing={1}>
            <Box sx={{ width: 8, height: 8, borderRadius: '50%', bgcolor: colors[status] || colors.Good }} />
    ...
    <Box sx={{ p: { xs: 2, md: 4 }, bgcolor: '#f4f7fe', minHeight: '100vh' }}>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        <Grid item xs={12} sm={4}>
          <SummaryCard title="Total Regions" value={areas.length} icon={<NetworkIcon />} color="#4318FF" />
        </Grid>
        <Grid item xs={12} sm={4}>
          <SummaryCard title="Active Areas" value={activeAreasCount} icon={<ActiveIcon />} color="#05CD99" />
        </Grid>
        <Grid item xs={12} sm={4}>
          <SummaryCard
...
const SummaryCardold = ({ title, value, icon, color }) => (
