...
const StaffService = {
  ...
  refreshToken: (data) => axiosInstance.post('/refresh-token', data).then((res) => res.data),
  ...
  logout: (data) => axiosInstance.post('/logout', data).then((res) => res.data),
  getDashboard: () => axiosInstance.get('/dashboard').then((res) => res.data),

  // ----------------
  // Admin: Staff Management
  // ----------------
  createStaff: (data) => axiosInstance.post('/create', data).then((res) => res.data),
