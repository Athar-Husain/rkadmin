...
export const sendNotification = createAsyncThunk('notifications/send', async (data, thunkAPI) => {
  try {
...
export const sendNotificationToAll = createAsyncThunk('notifications/sendToAll', async (data, thunkAPI) => {
  try {
    return await notificationService.sendNotificationToAllCustomers(data);
  } catch (error) {
    return thunkAPI.rejectWithValue(getError(error));
  }
});
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getNotifications.fulfilled, (state, action) => {
        ...
        toast.success('Notification Found successfully!');
      })
          ...
          const msg =
            typeof action.payload === 'string'
              ...
              : action.payload?.message && typeof action.payload.message === 'string'
                ...
                : JSON.stringify(action.payload?.message || 'Something went wrong');
