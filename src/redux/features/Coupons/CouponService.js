...
const CouponService = {
  ...
  createCoupon2: (data) => axiosInstance.post('/createCoupon2', data).then((res) => res.data),
  getAllCouponsAdmin: () => axiosInstance.get('/getAllCoupons').then((res) => res.data),
  updateCoupon: (id, data) => axiosInstance.put(`/updateCoupon/${id}`, data).then((res) => res.data),
  getCouponAnalytics: () => axiosInstance.get('/analytics').then((res) => res.data),
  getRedemptionHistory: (id, params) => axiosInstance.get(`/getRedemptionHistory/${id}/redemptions`, { params }).then((res) => res.data),

  // ----------------
  // User
  // ----------------
  getMyCoupons: (params) => axiosInstance.get('/my', { params }).then((res) => res.data),
  ...
  validateForStaff: (data) => axiosInstance.post('/validateForStaff', data).then((res) => res.data),
