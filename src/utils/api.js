...
export const promotionAPI = {
  ...
  // User / Public
  // ----------------
  getActive: (params) => api.get(`${PROMOTION}/active/list`, { params }).then((res) => res.data),
  recordImpression: (id) => api.post(`${PROMOTION}/${id}/impression`).then((res) => res.data),
  recordClick: (id) => api.post(`${PROMOTION}/${id}/click`).then((res) => res.data),
  recordRedemption: (id) => api.post(`${PROMOTION}/${id}/redeem`).then((res) => res.data)
};
...
export const bannerAPI = {
  ...
  // Admin
  // ----------------
  create: (data) => api.post(`${BANNER}`, data).then((res) => res.data),
  getAll: (params) => api.get(`${BANNER}`, { params }).then((res) => res.data),
  getById: (id) => api.get(`${BANNER}/${id}`).then((res) => res.data),
  update: (id, data) => api.patch(`${BANNER}/${id}`, data).then((res) => res.data),
  delete: (id) => api.delete(`${BANNER}/${id}`).then((res) => res.data),

  // ----------------
  // Public / User
  // ----------------
  getActive: (params) => api.get(`${BANNER}/active`, { params }).then((res) => res.data),
  recordImpression: (id) => api.post(`${BANNER}/${id}/impression`).then((res) => res.data),
  recordClick: (id) => api.post(`${BANNER}/${id}/click`).then((res) => res.data)
};
